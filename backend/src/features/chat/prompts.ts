...
- Never persist information that already exists in the filesystem. If you just read or found a fact, it is already stored — do not memorize() or write it again. Only persist information that is genuinely new.`;
